...
public class Level
{
    ...
    private static final Sprite[][] sprites =
        ...
        {   {   new PlayerSprite( 5, 5, 20, 20, Color.BLUE, null ),
                ...
                new GroundSprite( 300, 400, 30, 40, readImage("Assets\\grass.jpg") ),
                new GroundSprite( 400, 400, 450, 40, readImage("Assets\\grass.jpg") ),
                ...
                new GroundSprite( 750, 340, 50, 60, readImage("Assets\\grass.jpg") ),
                new GroundSprite( 800, 240, 51, 160, readImage("Assets\\grass.jpg") ),
                new GroundSprite( 1180, 210, 39, 190, readImage("Assets\\grass.jpg") ),
